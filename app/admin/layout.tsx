        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg font-medium text-sm transition-colors"
            >
          ...
          {/* Admin Navigation */}
          <nav className="flex gap-2 border-t border-white/20 pt-3">
            {navItems.map((item) => {
